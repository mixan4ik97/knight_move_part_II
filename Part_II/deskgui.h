...
protected:
    ...
    void resizeEvent(QResizeEvent *event); //Функция, обрабатывающия изменение размера виджета
...
private:
    ...
    void drawCellImage(uint8_t h,uint8_t w,int8_t num);
    ...
    QPixmap img_c[4];  // Контейнер, хранящий в себе загруженные изображения значков для шахматной доски в виде класса - контейнера QImage
    QPixmap img[4]; // Контейнер, хранящий в себе маштабируемые изображения значков для шахматной доски в виде класса - контейнера QImage
