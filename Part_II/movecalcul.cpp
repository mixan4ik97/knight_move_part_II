...
knight_pair MoveCalcul::calk_knight(uint8_t k1, const uint8_t &k2, uint64_t k_flags, uint8_t count, knight_pair cur_min) {
    ...
    if (k1 == k2){
      ...
      ret.first = count;
      ret.second = k_flags;
      if (n_flags & (_BV(0)) && !(k_flags & (GET_H1(k1))))
...
void MoveCalcul::startCalcul(uint8_t pos1, uint8_t pos2){
    ...
    try {
        ...
        switch(c_num){
            case 0 :if(!(n_flags & (_BV(0)))) break;ret = calk_knight(GET_H1(pos1), pos2, ret.second, 1,cur_min); break;
            case 1 :if(!(n_flags & (_BV(1)))) break;ret =  calk_knight(GET_H2(pos1), pos2, ret.second, 1,cur_min); break;
            case 2 :if(!(n_flags & (_BV(2)))) break;ret =  calk_knight(GET_H3(pos1), pos2, ret.second, 1,cur_min); break;
            case 3 :if(!(n_flags & (_BV(3)))) break;ret =  calk_knight(GET_H4(pos1), pos2, ret.second, 1,cur_min); break;
            case 4 :if(!(n_flags & (_BV(4)))) break;ret =  calk_knight(GET_H5(pos1), pos2, ret.second, 1,cur_min); break;
            case 5 :if(!(n_flags & (_BV(5)))) break;ret =  calk_knight(GET_H6(pos1), pos2, ret.second, 1,cur_min); break;
            case 6 :if(!(n_flags & (_BV(6)))) break;ret =  calk_knight(GET_H7(pos1), pos2, ret.second, 1,cur_min); break;
            case 7 :if(!(n_flags & (_BV(7)))) break;ret =  calk_knight(GET_H8(pos1), pos2, ret.second, 1,cur_min); break;
        }
